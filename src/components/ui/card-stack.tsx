...
export default function CardStack() {
  const initialCards: Card[] = [
    {
      id: 1,
      src: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=500&h=375&fit=crop",
      alt: "Card 1",
      title: "Alpine Peaks",
    ...
    {
      id: 2,
      src: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=500&h=375&fit=crop",
      alt: "Card 2",
    ...
    {
      id: 3,
      src: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500&h=375&fit=crop",
      alt: "Card 3",
    ...
    {
      id: 4,
      src: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=500&h=375&fit=crop",
      alt: "Card 4",
      title: "Misty Valley",
    ...
    {
      id: 5,
      src: "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=500&h=375&fit=crop",
      alt: "Card 5",
      title: "Starry Night",
    ...
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1511884642898-4c92249e20b6?w=500&h=375&fit=crop",
      alt: "Card 6",
    ...
    {
      id: 7,
      src: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=500&h=375&fit=crop",
      alt: "Card 7",
      title: "Rolling Hills",
    ...
    {
      id: 8,
      src: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?w=500&h=375&fit=crop",
      alt: "Card 8",
      title: "Aurora Dreams",
  ...
  return (
    <div className={`w-full h-screen flex items-center justify-center ${currentTheme.bg} transition-all duration-500 relative overflow-hidden`}>
      ...
      <div className="relative w-80 h-60 sm:w-96 sm:h-72 overflow-visible z-10">
